...
<h1>MANAGE MY FLEET</h1>
	...
	My Fleet Manager</span>&nbsp;&nbsp;&nbsp;
      <input name="cancel4" type="button" id="cancel4" value="Add Vehicle" onClick="location.href='trucks.php'" class="button"/>
      <input name="cancel5" type="button" id="cancel5" value="View My Fleet" onClick="location.href='<?php //echo base_url();?>view-my_trucks.php'" class="button"/>
    ...
    <table width="100%" border="0">
      <tr>
        <td width="79%" align="left" valign="top"><fieldset id="fieldset8" class="coolfieldset expanded">
		<legend>General</legend>
        <div style="display:;">
        <form action="<?php if(isset($edit)) { echo "ajaximage.php"; } else {echo "backend.php?addtruck=true";}?>" method="post" class="" enctype="multipart/form-data" id="<?php if(isset($edit)) { echo"imageform";}?>" >
                      ...
                      <td colspan="2" align="left" valign="top"><fieldset id="fieldset22" class="coolfieldset">
                            ...
                            <div  style="  display:block" align="left"> <table width="100%" border="0" cellspacing="0" cellpadding="5">
                              <tr>
                                ...
                                <td width="30%" align="left" scope="col" ><div <?php if(isset($edit)){ echo "class=\"editable_fueltype\""; }?>  id="trucks|truck_id|fueltype|<?php echo $companytruckdetails['truck_id']; ?>"><?php if(isset($edit)){ echo $companytruckdetails['fueltype'];} else { ?>
                                 
                                  <select name="fueltype" id="select2" value="" class="textfield">
                                    
								 <option value='N/D' selected>N/D</option>                                    <option value="Petrol">Petrol</option>
                              ...
                              <tr>
                                <td align="left" ><div <?php if(isset($edit)){ echo "class=\"editable_trucktype\""; }?>  id="trucks|truck_id|type|<?php echo $companytruckdetails['truck_id']; ?>"><?php if(isset($edit)){ echo $companytruckdetails['type'];} else { ?>
                                    <select name="type" id="select" value="" class="textfield">
                                ...
                                <td align="left" >
                                  ...
                                  <div <?php if(isset($edit)){ echo "class=\"editable_text\""; }?>  id="trucks|truck_id|model|<?php echo $companytruckdetails['truck_id']; ?>"><?php if(isset($edit)){ echo $companytruckdetails['model'];} else { ?>
                                    <input name="model" type="text" class="textfield" id="model" value="" size="20" title="Enter Plate Number" />
                                    <?php }?>
                                      <?php //echo $truck_id;?></div>
							...
							echo get_day_combo($selected_day, '', '', 'combo'); ?>
                                ...
                                <td align="left" >
                                  ...
                                  <div <?php if(isset($edit)){ echo "class=\"editable_text\""; }?>  id="trucks|truck_id|make|<?php echo $companytruckdetails['truck_id']; ?>"><?php if(isset($edit)){ echo $companytruckdetails['make'];} else { ?>
                                   <input name="make" type="text" class="textfield" id="make" value="" size="20" title="Enter Plate Number" />
                                                                            <?php }?>
                                      <?php //echo $truck_id;?></div>
                              ...
                              <tr>
                                <td align="left" >
                                  ...
                                  <div <?php if(isset($edit)){ echo "class=\"editable_text\""; }?>  id="trucks|truck_id|colour|<?php echo $companytruckdetails['truck_id']; ?>"><?php if(isset($edit)){ echo $companytruckdetails['colour'];} else { ?>
                                    <input name="colour" type="text" class="textfield" id="colour" value="" size="20" title="Enter colour" />
                                                                            <?php }?>
                                      <?php //echo $truck_id;?></div>
                                ...
                                <td align="left" >                                  
                                  <div <?php if(isset($edit)){ echo "class=\"editable_text\""; }?>  id="trucks|truck_id|enginenumber|<?php echo $companytruckdetails['truck_id']; ?>"><?php if(isset($edit)){ echo $companytruckdetails['enginenumber'];} else { ?>
                                   <input name="enginenumber" type="text" class="textfield" id="enginenumber" value="" size="20" title="Enter enginenumber" />
                                                                            <?php }?>
                                      <?php //echo $truck_id;?></div>
                              ...
                              <tr>
                                <td align="left" >
                                  ...
                                  <div <?php if(isset($edit)){ echo "class=\"editable_text\""; }?>  id="trucks|truck_id|engsize|<?php echo $companytruckdetails['truck_id']; ?>"><?php if(isset($edit)){ echo $companytruckdetails['engsize'];} else { ?>
                                   <input name="engsize" type="text" class="textfield" id="engsize" value="" size="20" title="Enter engsize" />
                                                                            <?php }?>
                                      <?php //echo $truck_id;?></div>
                                ...
                                <td align="left" >
                                  ...
                                  <div <?php if(isset($edit)){ echo "class=\"editable_text\""; }?>  id="trucks|truck_id|chasisno|<?php echo $companytruckdetails['truck_id']; ?>"><?php if(isset($edit)){ echo $companytruckdetails['chasisno'];} else { ?>
                                   <input name="chasisno" type="text" class="textfield" id="chasisno" value="" size="20" title="Enter chasisno Number" />
                                                                            <?php }?>
                                      <?php //echo $truck_id;?></div>
                              ...
                              <tr>
                                <td align="left" ><div <?php if(isset($edit)){ echo "class=\"editable_text\""; }?>  id="trucks|truck_id|tyresize|<?php echo $companytruckdetails['truck_id']; ?>"><?php if(isset($edit)){ echo $companytruckdetails['tyresize'];} else { ?>
                                  <input name="tyresize" type="text" class="textfield" id="tyresize" value="" size="20" title="tyresize"/>
                                  <?php }?></div><span class="textdescp">Tire Size</span></td>
                                <td align="left" ><div <?php if(isset($edit)){ echo "class=\"editable_text\""; }?>  id="trucks|truck_id|tyreno|<?php echo $companytruckdetails['truck_id']; ?>"><?php if(isset($edit)){ echo $companytruckdetails['tyreno'];} else { ?>
                                  <input name="tyreno" type="text" class="textfield" id="tyreno" value="" size="20" title="Number of tyres"/>
                                  <?php }?></div><span class="textdescp">Number of Tires</span></td>
                              </tr>
                            </table>
                           </div>   </fieldset></td>
          </tr>
...
<table width="63%" border="0" cellspacing="0" cellpadding="5">
                              <tr>
                                <td width="42%" align="left" scope="col" ><div <?php if(isset($edit)){ echo "class=\"editable_text\""; }?>  id="trucks|truck_id|insurer|<?php echo $companytruckdetails['truck_id']; ?>"><?php if(isset($edit)){ echo $companytruckdetails['insurer'];} else { ?>
                              ...
                              <tr>
                                <td align="left" ><div <?php if(isset($edit)){ echo "class=\"editable_text\""; }?>  id="trucks|truck_id|inscompany|<?php echo $companytruckdetails['truck_id']; ?>"><?php if(isset($edit)){ echo $companytruckdetails['inscompany'];} else { ?>
                                    <input name="inscompany" type="text" class="textfield" id="ownership4" value="" size="20"/>
                                    <?php }?></div>
                                    <span class="textdescp">Insurance Company</span></td>
                              </tr>
                              <tr>
                                <td align="left" ><div <?php if(isset($edit)){ echo "class=\"editable_text\""; }?>  id="trucks|truck_id|inscompany|<?php echo $companytruckdetails['truck_id']; ?>"><?php if(isset($edit)){ echo $companytruckdetails['insrefer'];} else { ?>
                                    <input name="insrefer" type="text" class="textfield" id="insrefer" value="" size="20"/>
                                    <?php }?></div>
                                    <span class="textdescp">Reference</span></td>
                              </tr>
                              <tr>
                                <td align="left" ><div <?php if(isset($edit)){ echo "class=\"editable_text\""; }?>  id="trucks|truck_id|insnotes|<?php echo $companytruckdetails['truck_id']; ?>"><?php if(isset($edit)){ echo $companytruckdetails['insnotes'];} else { ?>
                                    <input name="insnotes" type="text" class="textfield" id="insnotes" value="" size="20"/>
                                    <?php }?>
                                    </div><span class="textdescp">Note</span></td>
                              </tr>
                              <tr>
                                <td align="left"><table border="0" cellspacing="0" cellpadding="0">
                                    <tr>
							...
							echo get_day_combo($selected_day, '', '', 'combo'); ?>
                                ...
                                <span class="textdescp">Show reminder before</span>
                      ...
                      <td width="56%" align="left" valign="top"><fieldset  id="fieldset23" class="coolfieldset expanded">
                            <legend>Image</legend>
                              ...
                              <tr>
                                <th align="left" scope="col" ><div id='preview' style=" color:#FF0000;"><a <?php if(isset($edit)){echo "href=\"javascript:void(0)\"";}?>><img src='<?php  if(isset($companytruckdetails['image'])){ echo "upload/".$companytruckdetails['image']; } else {
					  	echo 'images/car.png';
		...
		$('#fieldset34').coolfieldset({collapsed:true});</script>
                             ...
                             <div id="cargo" align="left" style="vertical-align:top; display: "><table width="100%" border="0" cellspacing="0" cellpadding="5">
                              ...
                              <tr>
                                <td colspan="3" align="left" valign="top" ><div <?php if(isset($edit)){ echo "class=\"editable_text\""; }?>  id="trucks|truck_id|allowedcargo|<?php echo $companytruckdetails['truck_id']; ?>"><?php if(isset($edit)){ echo $companytruckdetails['allowedcargo'];} else { ?>   
                                  ...
                                  <?php }?></div><span class="textdescp">Allowed Cargo</span>
                                 </td>
                              </tr>
                            </table> 
                             </div>
                          ...
                          <fieldset id="fieldset29" class="coolfieldset">
                            ...
                            <div id="purchase" align="left" style="display: none"><table width="100%" border="0" cellspacing="0" cellpadding="5">
                              <tr>
                                <td width="47%" align="left" scope="col"><table border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                      <td nowrap="nowrap" ><div <?php if(isset($edit)){ echo "class=\"editable_text\""; }?>  id="trucks|truck_id|puchdate|<?php echo $companytruckdetails['truck_id']; ?>"><?php if(isset($edit)){ echo $companytruckdetails['puchdate'];} else { ?>  
							...
							echo get_day_combo($selected_day, '', '', 'combo'); ?>
                                  ...
                                  </table><span class="textdescp">Aquisition Date <?php if(isset($edit)){ echo '(YY/MM/DD)';}?></span>
                                    <br /></td>
                              </tr>
                              <tr>
                                <td align="left" ><div <?php if(isset($edit)){ echo "class=\"editable_text\""; }?>  id="trucks|truck_id|odoqui|<?php echo $companytruckdetails['truck_id']; ?>"><?php if(isset($edit)){ echo $companytruckdetails['odoqui'];} else { ?>                        <input name="odoqui" type="text" class="textfield" id="location2" value="<?php if(isset($companytruckdetails['odoqui'])){ echo $companytruckdetails['odoqui'];} else { echo '0';} ?>" size="20"/>
                                  km
                                  <?php }?></div>
                                  <span class="textdescp">Odometer at Aquisition</span></td>
                              </tr>
                              <tr>
                                <td align="left" ><div <?php if(isset($edit)){ echo "class=\"editable_text\""; }?>  id="trucks|truck_id|puchfrom|<?php echo $companytruckdetails['truck_id']; ?>"><?php if(isset($edit)){ echo $companytruckdetails['puchfrom'];} else { ?>             <input name="puchfrom" type="text" class="textfield" id="puchfrom" value="" size="20"/>
                                    <?php }?></div>
                                    <span class="textdescp">Purchase/Leased From</span>
                                  &nbsp;</td>
                              </tr>
                              <tr>
                                <td align="left" ><div <?php if(isset($edit)){ echo "class=\"editable_text\""; }?>  id="trucks|truck_id|price|<?php echo $companytruckdetails['truck_id']; ?>"><?php if(isset($edit)){ echo $companytruckdetails['price'];} else { ?>                <input name="price" type="text" class="textfield" id="price" value="<?php if(isset($companytruckdetails['price'])){ echo $companytruckdetails['price'];} ?>" size="20"/>
                                    <?php }?></div>
                                  <span class="textdescp">Cost of vehicle</span></td>
                              </tr>
                              <tr>
                                <td align="left"><table border="0" cellspacing="0" cellpadding="0">
                                    <tr>
							...
							echo get_day_combo($selected_day, '', '', 'combo'); ?>
                                  ...
                                  </table><span class="textdescp">Warranty expires on <?php if(isset($edit)){ echo '(YY/MM/DD)';}?></span>
                                    <br /></td>
                              </tr>
                              <tr>
                                <td align="left" ><div <?php if(isset($edit)){ echo "class=\"editable_textarea\""; }?>  id="trucks|truck_id|purchasecomment|<?php echo $companytruckdetails['truck_id']; ?>"><?php if(isset($edit)){ echo $companytruckdetails['purchasecomment'];} else { ?>
                                    <textarea name="purchasecomment" rows="8" cols="20">
                                  </textarea>
                                  
                                   
                                  <?php }?></div> <span class="smallbodytext"><b>Max 300 characters</b><strong>.</strong></span><br><span class="textdescp">Description</span></td>
                              </tr>
                            </table>
                            </div>
                        </fieldset>                        </td>
      ...
      <tr>
        <td align="left" valign="top"><fieldset id="fieldset13" class="coolfieldset expanded"><legend>Insurance</legend><div style=" display:none; " ><form id="register_step1" name="register_step1" method="post" action="" onSubmit="<?php //echo get_validation_javascript($required);?>"><table width="100%" border="0" cellspacing="0" cellpadding="10"><tr><td width="50%" align="left"><b><span class="bodyinstruction"><?php if($url2==rm) { echo 'Reminders'; } elseif(isset($companytruckdetails['regnumber'])){ echo '<b>'.'Managing Truck No.'.' '.'</b>'.'<font color= red >'.$companytruckdetails['regnumber'].'</font>';} else echo ' Select a truck to manage'; ?></span></b></td></tr>
               ...
               <br><span class="textdescp">Registration Number</span></td>
                            <td width="59%" align="left" scope="col" bgcolor="#FFFFFF" ><div <?php if(isset($edit)){ echo "class=\"editable_text\""; }?>  id="trucks|truck_id|payment|<?php echo $companytruckdetails['truck_id']; ?>"><?php if(isset($edit)){ echo $companytruckdetails['payment'];} else { ?>
                          ...
                          <tr>
                            <td align="left"  ><div <?php if(isset($edit)){ echo "class=\"editable_text\""; }?>  id="trucks|truck_id|policy|<?php echo $companytruckdetails['truck_id']; ?>"><?php if(isset($edit)){ echo $companytruckdetails['policy'];} else { ?>
...
Expires on</span></td>
                          ...
                          <tr>
							...
							echo get_day_combo($selected_day, '', '', 'combo'); ?>
                                ...
                                </table><span class="textdescp">Start Date <?php if(isset($edit)){ echo '(YY/MM/DD)';}?></span></td>
                            <td align="left" ><div <?php if(isset($edit)){ echo "class=\"editable_text\""; }?>  id="trucks|truck_id|deductible|<?php echo $companytruckdetails['truck_id']; ?>"><?php if(isset($edit)){ echo $companytruckdetails['deductible'];} else { ?>
                              <input name="deductible" type="text" class="textfield" id="deduc3" value="" size="20"/>
                              <?php }?></div>
      ...
      <tr>
        <td align="left" valign="top"><fieldset id="fieldset<?php if(isset($_GET['shw'])){echo '22';} else {echo '14';}?>" class="coolfieldset expanded"><legend>Service schedule</legend>
        <div style=" display:;" >
          <form id="register_step2" name="register_step1" method="post" action="backend.php?addservice=true" onSubmit="<?php // echo get_validation_javascript($required);?>">
		...
		?>    
                         <input name="truck_id" type="hidden" value="<?php echo $_GET['truck_id'];?>"  id="textbox6"/> <div <?php if(isset($_GET['service_id'])){ echo "class=\"editable_servicetype\""; }?>  id="services|service_id|name|<?php echo $truckservices['service_id']; ?>">    <?php if(isset($_GET['service_id'])){ echo "<b>".$truckservices['name']."</b>";} else { ?>
                              ...
                              <input name="company_id" type="hidden" value="<?php if(isset($userdetails['companyid'])){ echo $userdetails['companyid'];} ?>" /> <select name="name" class="textfield" id="name">
...
<span class="textdescp">Set date  reminder </span></td>
   ...
   $output = date("Y-m-d", $tomorrow);
		...
		if(isset($_GET['service_id'])){ echo $duenext;} ?>
                    ...
                    <tr>
                      <td align="right" valign="top"><?php if(!isset($_GET['service_id']) && isset($_GET['truck_id'])){ echo '<input name="save" type="submit" class="button" id="save" value="Save Data"/>';}else { echo '';}?>
                         <?php if(isset($_GET['truck_id'])) {?>   <input name="cancel" type="button" id="cancel" value="Add New" onClick="location.href='trucks.php?&shw=22&truck_id=<?php echo $truck_id;?>'" class="button"/><?php }?></td>
                      <td align="left" valign="top">&nbsp;</td>
                    </tr>
                    <tr>
                      <td colspan="3" align="left" valign="top"><div style="border: 5px solid #CCCCCC;padding:0px;width:100%;height:150px;overflow: auto" id="searchresults2">
                        <table width="100%" border="0" cellspacing="0" cellpadding="5">
                             <?php
	$query2 = "SELECT * FROM services where truck_id='".$truck_id."' and regnsd='N'";
	...
	?>   <tr>
                       ...
                       <?php do {?>    <tr style="<?php echo get_row_color($counter, 2);?>" class="<?php echo $services['service_id'];?>">
                              <td align="left"><a href="trucks.php?&truck_id=<?php echo $truck_id; ?>&service_id=<?php echo $services['service_id'];?>&shw=22">Update</a> | <a class="del" title="Delete Service " href="javascript:;" id="services|service_id|<?php echo $services['service_id']; ?>">Delete</a></td>
                          ...
                          <?php 
				  } while($services = mysql_fetch_assoc($query23)); 
		...
		?>  <table width="100%" border="0" cellspacing="0" cellpadding="5">
                          <tr>
                            ...
                            <td width="41%" align="left" scope="col"><?php if(isset($edit)){ echo "<b>".$companytruckdetails['regnumber']."</b>";} else { ?>
                              ...
                              <?php }?><br><span class="textdescp">Registration Number</span><input name="truck_id" type="hidden" value="<?php echo $_GET['truck_id'];?>" /></td>
...
<?php
	...
	?>  
							  ...
							  $query1322 = "SELECT * FROM drivers where driver_id='". $trucacc['driver_id']."'";
	...
	$row1322 = mysql_fetch_assoc($query1322);
							   ...
							   echo $row1322['fname'].' '.$row1322['lname'];} else { ?>
				...
				do{?>
							 ...
							 ?></div>
                              ...
                              <span class="textdescp">Driver</span>
                              
                              </td>
                            <td align="left" ><div <?php if($_GET['accident_id']){ echo "class=\"editable_text\""; }?>  id="accidents|accident_id|reference|<?php echo $trucacc['accident_id']; ?>"><?php if($_GET['accident_id']){ echo $trucacc['reference'];} else { ?>
                          ...
                          <tr>
                            <td align="left" valign="top" ><div <?php if($_GET['accident_id']){ echo "class=\"editable_textarea\""; }?>  id="accidents|accident_id|notes|<?php echo $trucacc['accident_id']; ?>"><?php if($_GET['accident_id']){ echo $trucacc['notes'];} else { ?>
                  ...
                  about the accident </span><br><span class="textdescp">Notes</span></td>
                         ...
                         <?php if(isset($_GET['truck_id'])) {?>    <input name="cancel2" type="button" id="cancel2" value="Add New" onClick="location.href='trucks.php?&acc=22&truck_id=<?php echo $truck_id;?>'" class="button"/><?php }?></td>
                            <td align="left" valign="top">&nbsp;</td>
                          </tr>
                          <tr>
       ...
       <?php
	$query3 = "SELECT * FROM accidents where truck_id='".$_GET['truck_id']."'";
	...
	?>     <tr>
            ...
            <td width="24%" align="left"><b>Date Created</b> </td>
                       ...
                       <?php 
				do{?> <tr style="<?php echo get_row_color($counter, 2);?>" class="<?php echo $accident['accident_id'];?>">
            <td align="left"><a href="trucks.php?&truck_id=<?php echo $truck_id; ?>&accident_id=<?php echo $accident['accident_id'];?>&acc=22">Update</a> | <a class="del" title="Delete?" href="javascript:;" id="accidents|accident_id|<?php echo $accident['accident_id']; ?>">Delete</a></td>
	...
	?> <?php echo $row132['fname'].' '.$row132['lname'];?></a></td>
            <td align="left">[<?php echo $accident['date_created']?>]</td>
            </tr><?php 
				  } while($accident = mysql_fetch_array($query3));
      ...
      <tr>
        <td align="left" valign="top"><fieldset id="fieldset<?php if(isset($_GET['tr'])){echo '22';} else {echo '16';}?>" class="coolfieldset expanded"><legend>Tires</legend><div style=" display: ;" ><form id="register_step1" name="register_step1" method="post" action="backend.php?addtires=true" onSubmit="<?php //echo get_validation_javascript($required);?>"><table width="100%" border="0" cellspacing="0" cellpadding="10"><tr><td align="left"><b><span class="bodyinstruction"><?php if($url2==rm) { echo 'Reminders'; } elseif(isset($companytruckdetails['regnumber'])){ echo '<b>'.'Managing Truck No.'.' '.'</b>'.'<font color= red >'.$companytruckdetails['regnumber'].'</font>';} else echo ' Select a truck to manage'; ?></span></b></td></tr>
                    <tr>
 ...
 <input name="make" type="text" class="textfield" id="cost" value="<?php if(isset($trucktire['make'])){ echo $trucktire['make'];} ?>" size="20"/>
                              <?php }?></div><span class="textdescp">Make</span></td>
                          </tr>
                          <tr>
                            <td align="left"><table border="0" cellspacing="0" cellpadding="0">
                      <tr>
                  ...
                  <span class="textdescp">Notes</span></td>
                          ...
                          <?php if(isset($_GET['truck_id'])) {?>  <input name="cancel2" type="button" id="cancel2" value="Add New" onClick="location.href='trucks.php?&tr=22&truck_id=<?php echo $truck_id;?>'" class="button"/><?php }?></td>
                            <td align="left" valign="top">&nbsp;</td>
                          </tr>
                          <tr>
        ...
        <?php
	$query4 = "SELECT * FROM tires where truck_id='".$_GET['truck_id']."'";
	...
	?>   <tr>
            ...
            <td width="30%" align="left"><b>Date Created</b> </td>
                       ...
                       <?php 
				do {?><tr style="<?php echo get_row_color($counter, 2);?>" class="<?php echo $tire['tire_id'];?>">
            <td align="left"><a href="trucks.php?&truck_id=<?php echo $truck_id; ?>&tire_id=<?php echo $tire['tire_id'];?>&tr=22">Update</a> | <a class="del" title="Delete?" href="javascript:;" id="tires|tire_id|<?php echo $tire['tire_id']; ?>">Delete</a></td>
            <td align="left"><?php echo $tire['qty'];?></td>
            <td align="left"><?php echo $tire['total'];?></td>
            <td align="left"><?php echo $tire['make'];?></td>
            <td align="left">[<?php echo $tire['date_created']?>]</td>
            </tr><?php 
				  } while($tire = mysql_fetch_array($query4));
      ...
      <tr>
        <td align="left" valign="top"><fieldset id="fieldset<?php if(isset($_GET['fl'])){echo '22';} else {echo '17';}?>" class="coolfieldset expanded">
                ...
                <div><table width="100%" border="0" cellspacing="0" cellpadding="10">
                  <tr>
                    <td width="39%" align="left" scope="col" ><?php if(isset($edit)){ echo "<b>".$companytruckdetails['regnumber']."</b>";} else { ?>
                        ...
                        <?php }?>
                      <br />
                      <span class="textdescp">Registration Number</span>                        <input name="truck_id" type="hidden" value="<?php echo $truck_id;?>" />
</td>
                    <td width="61%" align="left" scope="col" ><div <?php if($_GET['fuel_id']){ echo "class=\"editable_text\""; }?>  id="fuel|fuel_id|cost_qty|<?php echo $truckfuel['fuel_id']; ?>"><?php if($_GET['fuel_id']){ echo $truckfuel['cost_qty'];} else { ?>
                        <input name="cost" type="text" class="textfield" id="cost" value="" size="20"/>
                        <?php }?>
                      </div>
                  ...
                  <tr>
                    <td align="left" ><div <?php if($_GET['fuel_id']){ echo "class=\"editable_text\""; }?>  id="fuel|fuel_id|qty|<?php echo $truckfuel['fuel_id']; ?>"><?php if($_GET['fuel_id']){ echo $truckfuel['qty'];} else { ?>
                        <input name="qty" type="text" class="textfield" id="policy2" value="" size="20"/>
                        <?php }?></div>
                      
                      <span class="textdescp">Qty in ltrs</span></td>
                    <td align="left" ><?php if($_GET['fuel_id']){ echo "<b>".$truckfuel['qty']*$truckfuel['cost_qty']."</b>";} else { ?>
                  ...
                  <tr>
                    <td align="left" ><div <?php if($_GET['fuel_id']){ echo "class=\"editable_text\""; }?>  id="fuel|fuel_id|startodo|<?php echo $truckfuel['fuel_id']; ?>"><?php if($_GET['fuel_id']){ echo $truckfuel['startodo'];} else { ?>
                        <input name="startodo" type="text" class="textfield" id="policy5" value="" size="20"/>
                        <?php }?></div>
                      <span class="textdescp">Start odometer</span></td>
                    <td align="left" ><div <?php if($_GET['fuel_id']){ echo "class=\"editable_text\""; }?>  id="fuel|fuel_id|endodo|<?php echo $truckfuel['fuel_id']; ?>"><?php if($_GET['fuel_id']){ echo $truckfuel['endodo'];} else { ?>
                        <input name="endodo" type="text" class="textfield" id="deduc2" value="" size="20"/>
                        <?php }?>
</div>                      <span class="textdescp">End odometer</span></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td align="right" valign="top"><?php if(!isset($_GET['fuel_id']) && isset($_GET['truck_id'])){ echo '<input name="save" type="submit" class="button" id="save" value="Save Data"/>';}else { echo '';}?>
                      <?php if(isset($_GET['truck_id'])) {?> <input name="cancel3" type="button" id="cancel3" value="Add New" onClick="location.href='trucks.php?&fl=22&truck_id=<?php echo $truck_id;?>'" class="button"/><?php }?></td>
                    <td align="left" valign="top">&nbsp;</td>
                  </tr>
                  <tr>
                    <td colspan="4" align="left" valign="top"><div style="border: 5px solid #CCCCCC;padding:0px;width:100%;height:150px;overflow: auto" id="searchresults3">
                      <table width="100%" border="0" cellspacing="0" cellpadding="5">
                        <?php
	$query5 = "SELECT * FROM fuel where truck_id='".$_GET['truck_id']."'";
  ...
  <tr>
                            ...
                            <td width="30%" align="left"><b>Date Created</b> </td>
                                                  ...
                                                  <?php 
				do {?>
                        <tr style="<?php echo get_row_color($counter, 2);?>" class="<?php echo $fuel2['fuel_id']; ?>">
                            <td align="left"><a href="trucks.php?&truck_id=<?php echo $truck_id; ?>&fuel_id=<?php echo $fuel2['fuel_id'];?>&fl=22">Update</a> | <a class="del" title="Delete?" href="javascript:;" id="fuel|fuel_id|<?php echo $fuel2['fuel_id']; ?>">Delete</a></td>
                        ...
                        <?php 
				  } while($fuel2 = mysql_fetch_array($query5));
      ...
      <tr>
        <td align="left" valign="top"><fieldset id="fieldset18" class="coolfieldset expanded"><legend>Photos</legend><div style=" display: ; "><form id="imageform2" name="" method="post" action="upload.php"   enctype="multipart/form-data"><table width="100%" border="0" cellspacing="0" cellpadding="10">
          <tr><td width="32%" align="left"><b><span class="bodyinstruction"><?php if($url2==rm) { echo 'Reminders'; } elseif(isset($companytruckdetails['regnumber'])){ echo '<b>'.'Managing Truck No.'.' '.'</b>'.'<font color= red >'.$companytruckdetails['regnumber'].'</font>';} else echo ' Select a truck to add  photos'; ?></span></b></td>
                    ...
                    <tr>
                      <td align="left" scope="col" valign="top"><?php if(isset($action)){ echo "<b>".$companytruckdetails['regnumber']."</b>";} else { ?>
                        ...
                        <td width="68%" rowspan="3" align="left" valign="top" scope="col"><img src='<?php  if(isset($edit)){ echo "upload/".$companytruckdetails['image'];} else {echo 'images/car.png';} ?>' width="<?php if($companytruckdetails['image']){echo '200';}?>" height="<?php if($companytruckdetails['image']){echo '150';}?>" alt='' border='0'/>                        <br>
            <span class="textdescp">Default image</span>  <br><table width="36%" border="0" style="margin-top:25px;">
                            
                              <?php
	$result = "SELECT * FROM images where truck_id='".$_GET['truck_id']."'";
...
if($counter==0){	?>
              <tr>
                      <?php } ?>
        <td align="left" valign="top"><a href="uploads/<?php echo $im['image'];?>" rel="lightbox[roadtrip]" title="<?php echo $im[''];?>"><img src="uploads/<?php echo $im['image'];?>" width="178" height="147" border="0" align="middle" /></a></td>
      <?php 
							$counter++;
							if($counter==3){
							   $counter=0;?>
      ...
      <tr>
        <td align="left" valign="top"><fieldset id="fieldset19" class="coolfieldset expanded">
          <legend>Files</legend><div style=" display:;" ><form id="imageform3" name="register_step1" method="post" action="upload-file.php"  enctype="multipart/form-data"><table width="100%" border="0" cellspacing="0" cellpadding="10"><tr><td align="left" colspan="2"><b><span class="bodyinstruction"><?php if($url2==rm) { echo 'Reminders'; } elseif(isset($companytruckdetails['regnumber'])){ echo '<b>'.'Managing Truck No.'.' '.'</b>'.'<font color= red >'.$companytruckdetails['regnumber'].'</font>';} else echo ' Select a truck to add files'; ?></span></b></td></tr>
                    <tr>
                      <td colspan="2" align="left" valign="top" scope="col"><?php if(isset($action)){ echo "<b>".$companytruckdetails['regnumber']."</b>";} else { ?>
                        ...
                        <td width="75%" rowspan="3" align="left" valign="top" scope="col"><table width="47%" border="0" >
                              ...
                              <?php
	$result2 = "SELECT * FROM files where truck_id='".$_GET['truck_id']."'";
...
echo "<img src='images/icons/word-logo.png' class='preview' width='50px' height='50px'>";
}
if($ext=="pdf"){
echo "<img src='images/icons/pdf-logo.jpg' class='preview' width='50px' height='50px'>";
}
if($ext=="xls"){
echo "<img src='images/icons/excel-logo.png' class='preview' width='50px' height='50px'>";
}
 if($ext=="txt")
{echo "<img src='images/icons/txt-logo.png' class='preview' width='50px' height='50px'>";}
?></div>
<a href="uploads/documents/<?php echo $im2['file'];?>" target="_blank" ><?php echo $im2['file'];?></a></td>
      <?php 
							$counter++;
							if($counter==3){
							   $counter=0;?>
