...
session_start();
			...
			if(count($errorList)<1){
				...
				foreach($allowed_ext as $ext){
					if($ext==end($file_ext)){
						...
						$sql 		= 		"UPDATE companyprofile SET Logo = '$newfilename' WHERE CompanyID = '".$_SESSION['UserID']."'";
	...
	if($imgUploaded){ ?>
    	...
    	<a href="#" id="showEdit" title="Change profile picture?"><img src='thumb.php?src=<?php echo $upload_image; ?>&w=170&h=170&zc=1&q=170' width="170"/></a>
