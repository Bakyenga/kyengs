...
<body class="mainbg">
 <table width="100%" border="0" cellspacing="0" cellpadding="10">
      <tr>
        <td colspan="3" align="left" class="heads" bgcolor="#FFFFFF"><b>STEP 6 - MANAGE SHIPMENTS</b></td>
			...
			<table width="100%" border="0">
      			<tr>
        			<td width="79%" rowspan="2" align="left" valign="top">
                    	<ul class="css-tabs">
                            <li><a onClick="linkclicked()" href="companyprofile/shipmentadd.php<?php if(isset($_GET['token'])){ echo "?token=".$_GET['token']."&4ct10n=mohetide"; } if(isset($_GET['3du'])){ echo "&3du=".$_GET['3du']; } ?>">ADD NEW SHIPMENT</a></li>
                            <li><a onClick="linkclicked()" href="companyprofile/shipmentdata.php">MANAGE ALL SHIPMENTS</a></li>
                        </ul> 
