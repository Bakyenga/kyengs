    ...
    <td width="78%" valign="top"><form id="imageform2" name="register_step1" method="post" action="backend.php?assign=true" >
      <table width="100%" border="0" cellspacing="0" cellpadding="10">
			  ...
			  if(isset($msg)){
                ...
                <tr>
                  <td colspan="5" align="left" valign="top" nowrap="nowrap" bgcolor="#FFFFFF" style="padding:10px 5px 10px 10px;"><span class="heads">Assigned Drivers </span>&nbsp;&nbsp;
...
driver_assigments.truck_id, driver_assigments.date_of_assignment, companydrivers.Firstname, companydrivers.Lastname,
trucks.regnumber FROM companydrivers INNER JOIN driver_assigments ON companydrivers.ID = driver_assigments.driver_id INNER JOIN trucks ON driver_assigments.truck_id = trucks.truck_id
WHERE trucks.truck_id = "'.$_GET['truck_id'].'" and trucks.company_id="'.$_SESSION['UserID'].'"';
...
<?php 
  	...
  	$item ="";
			...
			$item ="#F5F5F5";?><tr bgcolor="<?php echo $item;?>"  style="">            <td align="left"><label><a rel="facebox" href="companyprofile/fleet/driver_details.php?&token=<?php echo $driver['driver_id'];?>&flag=<?php echo $driver['driver_id']; ?>"><?php echo $driver['Firstname'].' '.$driver['Lastname']?></a></label></td>
            </tr><?php 
 ...
 <?php
	$query13 = "SELECT * FROM trucks where driver_id='".$companytruckdetails['driver_id']."' and company_id='".$_SESSION['UserID']."'";
	...
	?> <tr >            <td align="left" style="color:#990000;"><label><b><?php echo $row132['Firstname'].' '.$row132['Lastname']?></b></label></td>
              </tr>
                      </table>              </td><td>&nbsp;</td>
                  <td>&nbsp;</td>
                </tr>
