...
<body>
 ...
 <?php
  ...
  <tr>
    <td align="left" bgcolor="#FFFFFF" style="padding:0px 5px 0px 10px;"></td>
  ...
  <tr>
    <td width="78%" valign="top"><form id="imageform2" name="register_step1" method="post" action="backend.php?assign=true" >
      <table width="100%" border="0" cellpadding="5">
          ...
          <tr>
            <td colspan="2" align="left" bgcolor="#FFFFFF" ><span class="heads">STEP 4 - ASSIGNING DRIVER TO A TRUCK </span>
      ...
      <input name="cancel4" type="button" id="cancel4" value="Add Vehicle" onClick="location.href='dashboard.php?p=<?php echo encryptValue("company"); ?>&flag=<?php echo encryptValue("compTruckz"); ?>'" class="button"/></td>
          ...
          <tr>
            ...
            <td width="80%"><input name="companyid" type="hidden" value="<?php if(isset($userdetails['companyid'])){ echo $userdetails['companyid'];} ?>" />
              <input name="truck_id" type="hidden" value="<?php echo $_GET['truck_id']; ?>" />   <input name="assid" type="hidden" value="<?php echo $_SESSION['assdriver']; ?>" /> 
              <b>
          ...
          <tr>
            ...
            <?php
			$ass='N';
	$truckaccidents = "SELECT * FROM companydrivers WHERE CompanyID='".$_SESSION['UserID']." ' and assigned='".$ass."' ";
...
<tr bgcolor="<?php echo $item;?>" style="">            <td colspan="2" align="center"><div id="HPnavParent0" style="position: relative; text-align:left; z-index: 45;">
	<table cellpadding="0" cellspacing="0" border="0"><tr><td><input type="text" name="driver" id="driver" value="<?php echo $detail['asset']; ?>" style="z-index:45;" onkeyup="showTopMenu(0,'incl/showdrivers.php?n=','driver');hideTopMenu(1);" onchange="setDiv('incl/driverdetails.php?a=','company_details','driver','');" onclick="hideTopMenu(0);" onlostfocus="" autocomplete ="off"/></td><td><a href="javascript:;" onclick="showTopMenu(0,'incl/showdrivers.php?a=','driver');hideTopMenu(1);"><img src="images/dropbtn.jpg" width="17" height="19" border="0" /></a></td>
	    <td><span id="customer_details"> </span></td>
	    <td>&nbsp;</td>
	</table><div name="topMenu0" id="topMenu0" class="topMenu" onmouseover="showTopMenu(0,'incl/showdrivers.php','driver');hideTopMenu(1);" onclick="hideTopMenu(0);" onmouseout="hideTopMenu(0);" style="position:absolute; background-color:#FFFFFF;z-index:45; overflow:auto; width:150px;"></div>
        </div></td>
            </tr>
        <td colspan="2" align="left">
     <br>
        <input name="save" type="submit" class="button" id="save" value="Assign Driver"/>
        <input name="cancel" type="button" id="cancel" value="Free Drivers" onclick="location.href='dashboard.php?p=<?php echo encryptValue("company"); ?>&amp;flag=<?php echo encryptValue("frr"); ?>'" class="button"/>
       </td>
            </table>
             <table width="100%" border="0">
  <tr>
