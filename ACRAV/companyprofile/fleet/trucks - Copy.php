...
<h1>MANAGE MY FLEET</h1>
    ...
    <table width="100%" border="0">
      <tr>
        ...
        <div style="display:;">
        <form action="<?php if(isset($edit)) { echo "companyprofile/fleet/ajaximage.php"; } else {echo "companyprofile/fleet/backend.php?addtruck=true";}?>" method="post" class="" enctype="multipart/form-data" id="<?php if(isset($edit)) { echo"imageform";}?>" >
...
Expires on</span></td>
      ...
      <tr>
        ...
        <div style=" display:;" >
          <form id="register_step2" name="register_step1" method="post" action="companyprofile/fleet/backend.php?addservice=true" onSubmit="<?php // echo get_validation_javascript($required);?>">
...
<?php
 ...
 <input name="make" type="text" class="textfield" id="cost" value="<?php if(isset($trucktire['make'])){ echo $trucktire['make'];} ?>" size="20"/>
	...
	?>   <tr>
      ...
      <div style=" display:;" >
        <form id="register_step3" name="register_step1" method="post" action="companyprofile/fleet/backend.php?addfuel=true" onSubmit="<?php //echo get_validation_javascript($required);?>">
         <?php
