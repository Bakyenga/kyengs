...
<table width="100%" border="0" cellspacing="0" cellpadding="10">
      <tr>
        <td colspan="3" align="left" class="heads" bgcolor="#FFFFFF"><b>STEP 3 - MANAGE COMPANY DRIVERS</b></td>
        <td width="3%" valign="top" align="left" rowspan="2">&nbsp;</td>
       </tr>
      <tr>
         <td colspan="2">
         	<ul class="css-tabs">
               <li><a onClick="linkclicked()" href="companyprofile/driveradd.php<?php if(isset($_GET['token'])){ echo "?token=".$_GET['token']."&4ct10n=mohetide"; } ?>">ADD NEW DRIVER</a></li>
               <li><a onClick="linkclicked()" href="companyprofile/driverdata.php">MANAGE ALL DRIVERS</a></li>
            </ul> 
