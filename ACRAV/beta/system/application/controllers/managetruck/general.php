          ...
          <td width="220" valign="top"><table width="100%" height="25" border="0" cellpadding="0" cellspacing="0">
			...
			$id = $this->session->userdata('companyid');
			 ...
			 $menudetails['menu'][0] = array('link'=>'userprofile/companyprofile', 'label'=>'Company details', 'current'=>'');
			  ...
			  $menudetails['menu'][4] = array('link'=>base_url().'index.php/companyprofile/companydrivers/', 'label'=>'Manage drivers', 'current'=>'');
			  $menudetails['menu'][5] = array('link'=>base_url().'index.php/companyprofile/payments/load_form/', 'label'=>'Manage payment settings', 'current'=>'');
          ...
          <td ><table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			?>
                <tr>
                  ...
                  <td width="29%" align="right">Cargo Weight: </td>
                ...
                <tr>
                  ...
                  <td align="left"><?php if(isset($action)){ echo "<b>".$companytruckdetails['enginenumber']."</b>";} else { ?>
                    <input name="enginenumber" type="text" class="textfield" id="enginenumber" value="<?php if(isset($companytruckdetails['enginenumber'])){ echo $companytruckdetails['enginenumber'];} ?>" size="30"/>
                    <?php }?></td>
                  <td align="right">Cargo Length: </td>
                  <td><?php if(isset($action)){ echo "<b>".$companytruckdetails['cargolength']."</b>";} else { ?>
                ...
                <tr>
                  ...
                  <td><?php if(isset($action)){ echo "<b>".$companytruckdetails['cargowidth']."</b>";} else { ?>
                ...
                <tr>
                  ...
                  <td align="left"><?php if(isset($action)){ echo "<b>".$companytruckdetails['enginenumber']."</b>";} else { ?>
                    <input name="enginenumber2" type="text" class="textfield" id="enginenumber2" value="<?php if(isset($companytruckdetails['enginenumber'])){ echo $companytruckdetails['enginenumber'];} ?>" size="30"/>
                    <?php }?></td>
                  <td align="right"> Cargo Height:</td>
                  <td><?php if(isset($action)){ echo "<b>".$companytruckdetails['cargoheight']."</b>";} else { ?>
                ...
                <tr>
                  <td align="left" valign="top" nowrap="nowrap">Colour:</td>
                  <td align="left" valign="top"><?php if(isset($action)){ echo "<b>".$companytruckdetails['enginenumber']."</b>";} else { ?>
                    <input name="enginenumber4" type="text" class="textfield" id="enginenumber4" value="<?php if(isset($companytruckdetails['enginenumber'])){ echo $companytruckdetails['enginenumber'];} ?>" size="30"/>
                    <?php }?></td>
                ...
                <tr>
                  <td align="left" valign="top" nowrap="nowrap">Model:</td>
                  <td align="left" valign="top"><?php if(isset($action)){ echo "<b>".$companytruckdetails['enginenumber']."</b>";} else { ?>
                    <input name="enginenumber3" type="text" class="textfield" id="enginenumber3" value="<?php if(isset($companytruckdetails['enginenumber'])){ echo $companytruckdetails['enginenumber'];} ?>" size="30"/>
                    <?php }?></td>
                  <td align="right" valign="top">&nbsp;</td>
                  <td valign="top">&nbsp;</td>
                  <td align="left" valign="top">&nbsp;</td>
                ...
                <tr>
                 ...
                 <?php if(!isset($action)){?>
                 <tr>
                   <td align="left">Assigned tracker:</td>
                   <td colspan="4" align="left" nowrap="nowrap"><select name="trackerId" id="trackerId">
					...
					?>
                     ...
                     &nbsp;&nbsp;
                     Ownership:<?php if(isset($action)){ echo "<b>".$companytruckdetails['regnumber']."</b>";} else { ?>
                     <input name="companyid2" type="hidden" value="<?php if(isset($userdetails['companyid'])){ echo $userdetails['companyid'];} ?>" />
                     <input name="regnumber2" type="text" class="textfield" id="regnumber2" value="<?php if(isset($companytruckdetails['regnumber'])){ echo $companytruckdetails['regnumber'];} ?>" size="30"/>
                     <?php }?></td>
                 </tr>
                 <tr>
                   <td align="left">Driver:</td>
                   <td colspan="4" align="left" nowrap="nowrap"><?php if(isset($action)){ echo "<b>".$companytruckdetails['enginenumber']."</b>";} else { ?>
                     <input name="enginenumber6" type="text" class="textfield" id="enginenumber6" value="<?php if(isset($companytruckdetails['enginenumber'])){ echo $companytruckdetails['enginenumber'];} ?>" size="30"/>
                     <?php }?></td>
                 </tr>
                 <tr>
                   <td align="left">Location:</td>
                   <td colspan="4" align="left" nowrap="nowrap"><?php if(isset($action)){ echo "<b>".$companytruckdetails['enginenumber']."</b>";} else { ?>
                     <input name="enginenumber5" type="text" class="textfield" id="enginenumber5" value="<?php if(isset($companytruckdetails['enginenumber'])){ echo $companytruckdetails['enginenumber'];} ?>" size="30"/>
                     <?php }?>                     &nbsp;</td>
                 </tr>
                 <tr>
                  <td align="left">&nbsp;</td>
