...
class Email_handler extends Model{
	...
	{
		$link = $_SERVER['HTTP_HOST'].base_url()."index.php/user/confirm_company_user/".str_replace('=','_',$email_content['confirmationid']);
		$msg =	"Dear ".$email_content['firstname'].","
				...
				."<br><br><a href='http://".$link."' >http://".$link."</a>"
	...
	{
		$link = $_SERVER['HTTP_HOST'].base_url()."index.php/user/confirm_user/".str_replace('=','_',$email_content['confirmationid']);
		$msg =	"Dear ".$email_content['firstname'].","
