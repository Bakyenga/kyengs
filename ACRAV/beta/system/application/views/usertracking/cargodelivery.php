        ...
        <tr>
          <td width="220" valign="top"><table width="100%" height="25" border="0" cellpadding="0" cellspacing="0">
            <tr>
			  ...
			  $menudetails['menu'][1] = array('link'=>'markcargoforpickup', 'label'=>'Mark As Pick Up', 'current'=>'');
			  $menudetails['menu'][2] = array('link'=>'markcargofordelivery', 'label'=>'Mark As Delivered', 'current'=>'Y');
          ...
          <td ><table width="682" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td><table width="100%" border="0" cellspacing="0" cellpadding="10">
                <tr>
                  <td width="534" class="bottomtableborder_heading"><b>Mark As Delivered <?php
			  if(isset($msg)){
			  ...
			  ?> </b></td>
                ...
                <tr>
                  <td class="bottom_heading">Select from available trucks and add any comments on picked up cargo, then mark it as picked up. </td>
                </tr>
                <tr>
        ...
        <tr>
          <td><table width="100%" border="0" cellspacing="0" cellpadding="4">
            ...
            <tr class="even">
              ...
              <td width="25%"><b>Date Delivered </b></td>
            ...
            <tr class="odd">
              ...
              <td><label>
                <input type="text" name="textfield22" class="textfield" size="30" />
              </label></td>
            ...
            <tr class="even">
              ...
              <td><input type="text" name="textfield22" class="textfield" size="30"/></td>
              <td><label>
            ...
            <tr class="odd">
              ...
              <td><input type="text" name="textfield222" class="textfield" size="30"/></td>
              <td>Done.<a href="">Edit</a></td>
            </tr>
            <tr class="even">
              <td><a href="">TM745635245</a></td>
              ...
              <td><input type="text" name="textfield223" class="textfield" size="30"/></td>
            ...
            <tr class="odd">
              ...
              <td><input type="text" name="textfield224" class="textfield" size="30"/></td>
