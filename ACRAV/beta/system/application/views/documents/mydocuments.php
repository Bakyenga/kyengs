        ...
        <tr>
          <td width="220" valign="top"><table width="100%" height="25" border="0" cellpadding="0" cellspacing="0">
            <tr>
			  ...
			  $menudetails['menu'][0] = array('link'=>'mydocuments', 'label'=>'My Documents', 'current'=>'Y');
			  $menudetails['menu'][1] = array('link'=>'add_documents', 'label'=>'Add Document', 'current'=>'');
          ...
          <td ><table width="682" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td><table width="100%" border="0" cellspacing="0" cellpadding="10">
                <tr>
                  <td width="534" class="bottomtableborder_heading"><b>My Documents <?php
			  if(isset($msg)){
			  ...
			  ?> </b></td>
                ...
                <tr>
                  <td class="bottom_heading" valign="bottom">Max total file size allowed is 500KB. </td>
                </tr>
                <tr>
  ...
  <tr>
    <td><div style="padding:0px;width:700px;height:350px;overflow: auto" id='searchresults'>
      <table width="100%" border="0" cellspacing="0" cellpadding="10">
        <tr class="even">
          <td width="20%"><strong><u>12 Documents</u></strong></td>
