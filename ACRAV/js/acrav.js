...
function checkEmpty(fieldName, message,checkCaption) {
	if (isNullOrEmpty(document.getElementById(fieldName).value) || trimString(document.getElementById(fieldName).value) == checkCaption) {	
			alert(message);	
			return false;
		}
	return true;
