...
<table width="970" border="0" cellspacing="0" cellpadding="5" align="center">
  ...
  <tr>
    <td valign="top"><form id="loginform" name="loginform" method="post" action="<?php echo base_url();?>index.php/user/login" onsubmit="<?php echo get_validation_javascript($required);?>">
      <table width="446" border="0" cellspacing="0" cellpadding="6" align="center" class="tableborder">
        ...
        <tr>
          <td>&nbsp;</td>
          <td align="right"><a href="<?php echo base_url();?>index.php/user/register" class="smallbrownlinks"><b>Register</b></a>&nbsp; | &nbsp;<a href="#" class="smallbrownlinks">Forgot Password</a>&nbsp; | &nbsp;<a href="#" class="smallbrownlinks">Help</a> </td>
        </tr>
      </table>
        </form>    </td>
  </tr>
