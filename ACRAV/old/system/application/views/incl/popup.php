...
elseif($type == 'driver')
{
	$table_HTML = "<table width='100%' border='0' cellspacing='0' cellpadding='4'>".
                  "<tr>".
                   " <td colspan='2' class='bottomtableborder_heading'>Driver Details</td>".
                  "</tr>".
                  "<tr><td nowrap>First Name:</td><td><b>".$driverdetails['fname']."</b></td></tr>".
                  "<tr><td nowrap>Last Name:</td><td><b>".$driverdetails['lname']."</b></td></tr>".
                  "<tr><td nowrap>Phone Number:</td><td><b>".$driverdetails['telephone1']."</b></td></tr>".
                  "<tr><td nowrap>Date of birth:</td><td><b>".$driverdetails['dateofbirth']."</b></td></tr>".
                  "<tr><td nowrap>Driver Experience:</td><td><b>".$driverdetails['experiance']."</b></td></tr>".
                  "<tr><td nowrap>Acting As:</td><td><b>".$driverdetails['actingas']."</b></td></tr>".
