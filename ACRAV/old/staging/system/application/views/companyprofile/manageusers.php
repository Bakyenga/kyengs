...
<table width="970" border="0" cellspacing="0" cellpadding="5" align="center">
  <tr>
	...
	$userdetails['page'] = 'manageusers';
	$this->load->view('incl/header', $userdetails);?></td>
  </tr>
  <tr>
    <td valign="top"><form id="manageusers" name="manageusers" method="post" action="<?php 
			$url = base_url()."index.php/companyprofile/users/save_user"; 
        ...
        <tr>
          <td valign="top"><table width="100%" height="25" border="0" cellpadding="0" cellspacing="0">
            <tr>
			  ...
			  $menudetails['menu'][0] = array('link'=>base_url().'index.php/companyprofile/profile/load_form/id/'.$companydetails['id'].'/action/view', 'label'=>'Company details', 'current'=>'');
			  $menudetails['menu'][1] = array('link'=>base_url().'index.php/companyprofile/users/load_form/action/view', 'label'=>'Manage company users', 'current'=>'Y');
  ...
  <tr>
    <td class="bottomtableborder_heading"><b>Step 2 - Manage Company Users </b></td>
  </tr>
  <tr>
    ...
    <td><table width="104%" border="0" cellspacing="0" cellpadding="10">
                ...
                <tr>
                  ...
                  <td colspan="3"><table width="100%" border="0" cellspacing="0" cellpadding="2">
                    <tr>
                      <td width="1%"><?php if(isset($companyuserdetails)){ echo '<input name="save" type="submit" class="button" id="save" value="Update User"/>';}else { echo '<input name="save" type="submit" class="button" id="save" value="Add User"/>';}?></td>
    ...
    <td><div  style="border: 5px solid #CCCCCC;padding:5px;width:95%;height:200px;overflow: auto" id="searchresults">
      <table width="100%" border="0" cellspacing="0" cellpadding="5">
        ...
        <tr style="<?php echo get_row_color($counter, 2);?>">
          <td><a href="<?php echo base_url();?>index.php/companyprofile/users/load_form/id/<?php echo $user['id'];?>">Update</a> | <a href="javascript:void(0)" onclick="deleteEntity('<?php echo base_url();?>index.php/companyprofile/users/delete_user_data/id/<?php echo $user['id'];?>','user','<?php echo $user['firstname'].' '.$user['lastname'];?>');">Delete</a></td>
