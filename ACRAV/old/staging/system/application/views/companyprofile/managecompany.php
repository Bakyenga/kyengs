        ...
        <tr>
          <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
			  ...
			  $menudetails['menu'][2] = array('link'=>base_url().'index.php/companyprofile/companytrucks/load_form/id/'.$companydetails['id'].'', 'label'=>'Manage trucks', 'current'=>'');
			  $menudetails['menu'][3] = array('link'=>base_url().'index.php/companyprofile/companycargo/load_form/id/'.$companydetails['id'].'', 'label'=>'Manage cargo', 'current'=>'');
			  $menudetails['menu'][4] = array('link'=>base_url().'index.php/companyprofile/companydrivers/load_form/id/'.$companydetails['id'].'', 'label'=>'Manage drivers', 'current'=>'');
			  $menudetails['menu'][5] = array('link'=>base_url().'index.php/companyprofile/payments/load_form/id/'.$companydetails['id'].'/action/view', 'label'=>'Manage payment settings', 'current'=>'');
          ...
          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td><table width="100%" border="0" cellspacing="0" cellpadding="10">
                <tr>
                  <td colspan="3" align="left" class="bottomtableborder_heading"><b>Step 1 - Company Details <?php if(isset($action)){?>[<a href="<?php echo base_url();?>index.php/companyprofile/profile/load_form/id/<?php echo $companydetails['id']?>" class="heading">edit</a>]<?php } ?></b></td>
                </tr>
				<?php
			  if(isset($msg)){
			  ...
			  ?>
                ...
                <tr>
                  ...
                  <td colspan="2" align="left"><?php if(isset($action)){ echo "<b>".date('F d, Y', strtotime($companydetails['dateestablished']))."</b>";} else { ?>
