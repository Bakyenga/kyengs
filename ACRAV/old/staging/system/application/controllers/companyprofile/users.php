...
class Users extends Controller {
	...
	function load_form()
	{
		...
		$users_array = $this->db->query($this->Query_reader->get_query_by_code('get_company_users', array('companyid'=>$this->session->userdata('companyid'))));
	...
	{	
		...
		#redirect('companyprofile/users/load_form/m/usersave');
	}
